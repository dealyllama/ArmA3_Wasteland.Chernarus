...
_setupObjects =
{
	...
	_missionHintText = format ["A group of snipers have set up over-watch. Head to the marked area and take them out!", sideMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["The snipers are dead! Outstanding!"];
