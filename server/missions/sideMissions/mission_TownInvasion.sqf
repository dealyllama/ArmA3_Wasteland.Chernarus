...
_setupVars =
{
	_missionType = "Militia Stronghold";
...
_setupObjects =
{
	...
	_missionHintText = format ["Elite civilian militia have taken over <br/><t size='1.25' color='%1'>%2</t>!<br/><br/>There seem to be <t color='%1'>%3 enemies</t> hiding inside or on top of buildings. Reclaim the town and take their supplies!<br/>Watch out for those windows!", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Nice work!<br/><br/><t color='%1'>%2</t><br/>is safe again!<br/>Their gear is now yours!", sideMissionColor, _townName];
