...
[MF_ITEMS_CANNED_FOOD, "Canned Food", {33 call mf_items_survival_eat}, "Land_BakedBeans_F","client\icons\cannedfood.paa", 6] call mf_inventory_create;
[MF_ITEMS_WATER, "Water Bottle", {33 call mf_items_survival_drink}, "Land_BottlePlastic_V2_F","client\icons\waterbottle.paa", 6] call mf_inventory_create;
